...
<div className="content">
        <div className="post-list">
          <div className="post-item">
            <h3>Red Basa - Sanatorio General Sarmiento</h3>
            <div className="info">
              <h5>2023 - Actual</h5>
              <h5>|</h5>
              <h5>Recepción | Administración</h5>
            </div>
            <p>Desde Junio del 2023 trabajo en el área de salud en el Sanatorio General Sarmiento de San Miguel Buenos Aires. Inicie en el área de recepción de guardia donde <strong>la empatía y la calidad humana </strong> son muy importantes, ya que llegan pacientes o familiares de pacientes y es imprescindible escucharlos y ayudarlos. Mi trabajo consistía en realizar la recepción de los pacientes y derivarlos a los especialistas correspondientes. Tambien aprendi el trabajo de otros sectores y en menos de 6 meses ya sabia realizar internaciones, recepcionar y dar turnos a pacientes de consultorios y trabajar en el área de cobros. <br/> En diciembre la empresa Red Basa, compro el sanatorio y con el inicio de las vacaciones algunos puestos requirieron ayuda. Por lo que en el área de auditorias medicas faltaba gente, viendo mi <strong> capacidad para aprender y adaptarme </strong> decidieron que acuda a ese sector a aprender. Mi desempeño en el área fue tan bueno que me valió el ascenso al sector en los inicios de febrero. Mi actual trabajo consiste en leer las historias clínicas y partes quirúrgicos de los pacientes, relevar información de internados y derivar todo eso a las obras sociales para su facturación. Un trabajo que requiere mucha <strong> meticulosidad y atención </strong> para que nada se pase por alto.</p>
          </div>
          <div className="post-item">
            <h3>Garbarino</h3>
            <div className="info">
              <h5>2011 - 2021</h5>
              <h5>|</h5>
              <h5>Jefe de deposito | Ventas | Atención al publico</h5>
            </div>
            <p>
            Inicie como <strong>jefe de deposito</strong>, donde era <strong>responsable</strong> de la mercadería del local, tambien de llevar el control de todos los remitos, hojas de ruta demás papeles importantes. Controlar auditorias corregir errores. Un trabajo que requería mucha <strong>atención y responsabilidad, junto con concentración y prestar atención a los detalles</strong>. <br/>
              En mis tiempos libres aprendía el trabajo de los chicos de service técnico, donde se desarmaban las PC y notebooks y se hacían instalaciones y actualizaciones de SO. <br/>
              Luego la empresa decidió transformar a todos en Polivalentes, eso queria decir que todos debíamos hacer el trabajo de caja, ventas y deposito. Algo con lo que no tenia problema ya que me gustaba aprender de todos los sectores. <br/>
              En el ultimo tiempo fui capacitado para sub-encargado de tienda algo que luego no llego debido al cierre de muchas sucursales y posterior despido de casi todos los empleados de sucursales.
              Al margen del final que no fue bueno, mi paso por la empresa fue de mucho valor para mi, ya que aprender muchas cosas y desarrollé muchas características que hoy hacen a mi forma de trabajar, entre ellas <strong>resiliencia</strong>, <strong>perseverancia</strong>, <strong>escucha activa</strong>, <strong>adaptabilidad</strong>.
          ...
          <div className="post-item">
            <h3>Compostura de calzados "Boyacá"</h3>
            <div className="info">
              <h5>2006 - 2011</h5>
              <h5>|</h5>
              <h5>Atención al publico | Reparación de calzados</h5>
            </div>
            <p>Mi primer trabajo con 17 años. Inicie ayudando a mis abuelos con su negocio familiar, el mismo que tenían desde mi nacimiento. Mi trabajo era <strong> atender a los clientes que entraban </strong>, brindarles productos para el cuidado de sus calzados, asesorarlos sobre precios y detectar los problemas del calzado que traían para poder repararlos. Además en mis tiempos libres <strong> aprendi trabajos </strong> de compostura, tanto viendo como se hacían los trabajos asi como realizándolos yo mismo con la supervisión de mi abuelo, hasta que aprendi a hacer varias cosas solo. Fue una experiencia increible, ya que aunque era un negocio familiar <strong> siempre me lo tome con mucha responsabilidad</strong> porque sabia lo que era para ellos porque habia crecido viéndolos trabajar. Los desafíos mas grandes fueron romper esa vergüenza de los 17 años y atender gente mayor que uno, pero con el tiempo fue algo natural. Tambien fue muy interesante aprender cosas nuevas y poder <strong> ser mas útil en mi trabajo</strong>.</p>
          </div>
        </div>
...
<div className="content">
        <div className="post-list">
          <div className="post-item">
            ...
            <p>Con mas de 800hs teórico practicas en programacion web, Proyectos completos full stack con back front y base de datos. Un bootcamp intenso de estudio, repaso y aprendizaje</p>
          </div>

          <div className="post-item">
            <h3>Tecnitacura Analista de Sistemas</h3>
            <div className="info">
              <h5>2019 - 2021</h5>
              <h5>|</h5>
              <h5>Instituto Raul Scalabrini Ortiz (pendiente ultimo año)</h5>
            </div>
            <p>
            Terciario en sistemas. 2 de 3 años completados (Pendiente el ultimo por problemas de pandemia y económicos) Con materias de relevancia como: <br/>
            C# <br/> HTML <br/> Java <br/> Redes <br/> SQL <br/> Sistemas, Hardware y Software <br/> Ingles Tecnico
            </p>

          </div>

          <div className="post-item">
            <h3>Perito Mercantil con Orientacion en Programacion</h3>
            <div className="info">
              <h5>2003 - 2007</h5>
              <h5>|</h5>
              <h5>Instituto Profesional San Jose | Secuandario Completo</h5>
            </div>
            <p>Secundario completo terminado en tiempo y forma, con materias de relevancia como programacion donde se vio C# de manera inicial como entrada al mundo informático.</p>
          </div>
        </div>
...
<h1 className="page-title">Habilidades Web</h1>
      <div className="content">
        <div className="post-list">
          <div className="post-item">
          ...
          <div className="post-item">
            <h3>Metodologias y otras tegnolocias</h3>
            <div className="info">
              <h5>2022</h5>
              <h5>|</h5>
              <h5>Bootcamp Henry</h5>
