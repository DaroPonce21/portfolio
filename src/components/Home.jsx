    ...
    <div>
      <div className="main">
        <div className="info">
          ...
          <p>
            ...
            <strong>Front-End:</strong> React Js. Redux
            <br />
            <strong>Back- End:</strong> Node Js. Express Js. <br />
      ...
      <div className="recent">
        ...
        <div className="posts">
          ...
          <div className="post-item">
            <h3>Metodologias y Servicios</h3>
            <div className="info">
              <h5>Scrum</h5>
              <h5>|</h5>
              <h5>GitFlow</h5>
      ...
      <div className="separator">
        <div className="header">
          <h4>Trabajo Destacado</h4>
          <Link className="mostrar" to="/works">
            Mostrar todo
          </Link>
        </div>
      </div>
